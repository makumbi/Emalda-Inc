...
function validateForm() {
    var x = document.forms["ourDeals"]["emails"].value;
    if (x == null || x == "") {
		...
		<div class="jumbotron text-center"> 
			<div class="position-text"> 
				...
				<p>We import fresh foods from African farmers to your door step</p>
	 			<form class="form-inline" name="ourDeals"
					onsubmit="return validateForm()" method="post" action="email_validation.php" autocomplete="off">Get Deals:
					<input type="email" name="emails" class="form-control" placeholder="Email Address" size="50">
					<button type="submit" class="btn btn-danger" value="Submit">Sign Up</button>
				</form> 
			</div>
		</div> 	
</header><!--**************************End Header*****************************-->
